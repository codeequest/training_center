...
export function PinIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path d="M12 21s6.5-5.4 6.5-10.5a6.5 6.5 0 0 0-13 0C5.5 15.6 12 21 12 21Z" strokeLinejoin="round" />
...
export function CoinIcon({ className = 'h-4 w-4' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path
        d="M9.3 15c0 1 1.1 1.6 2.7 1.6s2.7-.6 2.7-1.7c0-1-1.1-1.4-2.7-1.7s-2.7-.7-2.7-1.7c0-1 1.1-1.6 2.7-1.6s2.7.5 2.7 1.5"
        strokeLinecap="round"
      />
      <path d="M12 6.8v10.4" strokeLinecap="round" />
    </svg>
  );
}
...
export function SendIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path d="M4 4.5 20 12 4 19.5l2.5-7L4 4.5Z" strokeLinejoin="round" />
      <path d="M6.5 12H13" strokeLinecap="round" />
    </svg>
  );
}
...
export function EyeOffIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path d="M10.6 5.7A10.6 10.6 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a15.6 15.6 0 0 1-3.4 4.3M6.7 6.8C4.2 8.5 2.5 12 2.5 12s3.5 6.5 9.5 6.5a9.9 9.9 0 0 0 3.3-.6" strokeLinecap="round" strokeLinejoin="round" />
