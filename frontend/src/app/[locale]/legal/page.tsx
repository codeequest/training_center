...
export async function generateMetadata({
  ...
  return { title: getDictionary(locale).legal.title, robots: { index: false } };
}
    ...
    <div className="py-16 sm:py-24">
      <div className="container-page max-w-3xl">
        <MotionDiv {...revealProps}>
          <h1 className="section-title">{t.legal.title}</h1>
          <p className="mt-4 text-[15px] leading-relaxed text-ink-muted">{t.legal.intro}</p>
        </MotionDiv>
